...
#畫外圈
outerwedges, outerlabel,outerautotext= ax.pie(
            outerpie, radius=1.2, colors=outer_colors,
            autopct=lambda pct: func(pct,outerpie),
            pctdistance=0.8,
            textprops={'color':'r', 'size':20},
...
#畫內圈
innerwedges, innerlabel = ax.pie(
            innerpie, radius=1.2 - size, colors=inner_colors,
...
#設置圖例
ax.legend(outerwedges + innerwedges, outerlabels + legendlabel,
          title_fontsize=20,
          loc="center left",
...
ax.set_title('新竹遊憩據點遊客人次統計環圈圖', fontproperties = 梅圓, color = 'w', fontsize = 30)
